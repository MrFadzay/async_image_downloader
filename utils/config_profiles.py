...
from utils.config_manager import (
    AppConfig, DownloadConfig, PathConfig, ValidationConfig, 
    DuplicateConfig, UIConfig, ResourceConfig
)
...
class ConfigProfiles:
    ...
    @staticmethod
    def save_profile_as_config(profile_name: str, output_path: Path, format_type: str = "yaml") -> bool:
        """
