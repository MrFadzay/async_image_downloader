...
def create_argument_parser():
    ...
    # Команда download
    p_download = subparsers.add_parser("download", help="Download images from a file or URLs.")
    p_download.add_argument("-f", "--file", type=Path, help="Path to a file with URLs.")
    p_download.add_argument("-u", "--urls", nargs='+', help="List of URLs to download.")
    ...
    # Команда uniquify
    p_uniq = subparsers.add_parser("uniquify", help="Find and modify duplicate images to make them unique.")
