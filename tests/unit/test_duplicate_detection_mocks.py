...
class TestGetFileHashesMocks:
    ...
    async def test_get_file_hashes_with_duplicates(self):
        ...
        with patch('aiofiles.os.listdir', side_effect=mock_listdir_func), \
            ...
            with patch('asyncio.get_running_loop') as mock_loop, \
                 patch('asyncio.gather') as mock_gather, \
                 patch('utils.config.SIMILARITY_THRESHOLD', 2):
...
class TestHandleDuplicatesMocks:
    ...
    async def test_handle_duplicates_renames_files(self):
        ...
        mock_duplicates = [
            (Path("/test/dir/duplicate1.jpg"), ("h1", "h2", "h3"), Path("/test/dir/original.jpg")),
            (Path("/test/dir/duplicate2.jpg"), ("h1", "h2", "h3"), Path("/test/dir/original.jpg"))
        ]
        ...
        with patch('core.duplicates.create_dir') as mock_create_dir, \
            ...
            expected_calls = [
                call(Path("/test/dir/duplicate1.jpg"), Path("/test/dir/duplicate1_duplicate_1.jpg")),
                call(Path("/test/dir/duplicate2.jpg"), Path("/test/dir/duplicate2_duplicate_1.jpg"))
            ]
    ...
    async def test_handle_duplicates_handles_name_conflicts(self):
        ...
        mock_duplicates = [
            (Path("/test/dir/duplicate.jpg"), ("h1", "h2", "h3"), Path("/test/dir/original.jpg"))
        ]
        ...
        with patch('core.duplicates.create_dir'), \
            ...
            mock_rename.assert_called_once_with(
                Path("/test/dir/duplicate.jpg"),
                Path("/test/dir/duplicate_duplicate_2.jpg")
            )
...
class TestUniquifyDuplicatesMocks:
    ...
    async def test_uniquify_duplicates_success(self):
        ...
        mock_unique_hashes = {
            ("orig1", "orig2", "orig3"): Path("/test/dir/original.jpg")
        }
        ...
        with patch('core.duplicates.create_dir'), \
            ...
            mock_get_hashes.return_value = (mock_unique_hashes, mock_duplicates)
            ...
            async def mock_executor(*args):
                if args[1] == 'core.duplicates._apply_modifications_and_save_sync':
                    return None  # Modification successful
                else:
                    return ("new1", "new2", "new3")  # New unique hash
            ...
            with patch('utils.config.SIMILARITY_THRESHOLD', 2), \
                 patch('utils.config.MAX_UNIQUIFY_ATTEMPTS', 3):
    ...
    async def test_uniquify_duplicates_max_attempts_reached(self):
        ...
        mock_unique_hashes = {
            ("orig1", "orig2", "orig3"): Path("/test/dir/original.jpg"),
            ("h1", "h2", "h3"): Path("/test/dir/duplicate.jpg")  # Still duplicate after modification
        }
...
class TestUniquifyAllImagesMocks:
    ...
    async def test_uniquify_all_images_processes_all_files(self):
        ...
        mock_image_files = [
            Path("/test/dir/image1.jpg"),
            Path("/test/dir/image2.png"),
            Path("/test/dir/image3.gif")
        ]
    ...
    async def test_uniquify_all_images_handles_errors(self):
        ...
        mock_image_files = [
            Path("/test/dir/good.jpg"),
            Path("/test/dir/corrupted.jpg")
        ]
        ...
        with patch('core.duplicates.create_dir'), \
            ...
            mock_loop_instance.run_in_executor.side_effect = [None, Exception("Corrupt file")]
