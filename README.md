...
- **Улучшенная совместимость с PyInstaller** - решены проблемы со сборкой исполняемых файлов
...
*   **Универсальный режим скачивания:** Использует curl_cffi с имитацией браузера Chrome для обхода защиты сайтов (~1-2 сек/изображение)
*   **Асинхронное скачивание:** Эффективно скачивает изображения из списка URL или из файла, содержащего URL.
*   **Защита от блокировки:** Настраиваемая задержка между запросами и автоматическая имитация браузера для предотвращения блокировки.
...
2.  **Установите зависимости:**
    ...
    или вручную:
    ```bash
    pip install curl_cffi[aio] aiofiles Pillow imagehash questionary
    ```
...
*   **По списку URL:**
    ...
    **С задержкой между запросами (для защищенных сайтов):**
    ```bash
    python main.py download --urls https://avito.ru/img1.jpg https://avito.ru/img2.jpg --dest avito_images --delay 3
    ```
